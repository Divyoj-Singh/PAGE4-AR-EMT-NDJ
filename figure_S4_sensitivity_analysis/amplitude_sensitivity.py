# -*- coding: utf-8 -*-
"""
Created on Mon Feb  8 12:51:37 2021
@author: divyoj
"""
...
folder="./Amplitude/AtoZ=0.1_ZtoA=0.9/Sic=215000/mir200/"
...
tm1, index1, extr1 = find_extremal(tm, W1)
...
for parameter_id in p:
    ...
    tm2, index2, extr2 = find_extremal(tm, W2)
    ...
    tm3, index3, extr3 = find_extremal(tm, W3)
...
ax.set_xlabel("% change in Amplitude of mir200",fontsize=10)
ax.set_title("Snail="+str(parameter_dictionary['Sic']))      
#plt.legend(loc = 'upper left', ncol=2)
plt.subplots_adjust(top=0.80, bottom=0.30, left=0.20, right=0.95, hspace=0.25,wspace=0.5)
