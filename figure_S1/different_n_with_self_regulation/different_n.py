# -*- coding: utf-8 -*-
"""
Created on Mon Jun  1 13:33:54 2020
...
#%% Iterating over an array of n of interactions:
n_array=[2,4,6]
m_array=[2,4,6]
for n in n_array:
    for m in m_array:
        p['n']=m
        p['nA']=p['nC']=n
        filename="n_DNFL_AR_"+str(p['n'])+"_n_Page4_AR_"+str(p['nA'])
        print(filename)
        v1 = np.arange(0.0,1.01,0.02)
        v1=np.around(v1,2)
        v2 = np.arange(0.0,1.01,0.02)
        v2=np.around(v2,2)
